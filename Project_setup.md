...
There's a wide range in terms of how "readable" a project is. Below are some practices that can be adopted in projects, which should bring some organization to projects.\
**Disclaimer:** This is NOT a "the definitive guide" to organizing a data project; rather, adapt to your own projects. 

## Directory Structure

Here is the tl;dr(too long; didnt read) overview: everything gets its own place, and all things related to the project should be placed under child directories one directory. 
...
## `README.md`
It is most front-facing file in your repository. It should contain information that will help your forgetful future self, newcomers, and collaborators figure out *why* this project exists, how things are organized, conventions used in the project, and where they can go to find more information.\
